...
// AWS Info
  ...
  if (isset($_POST['upload'])) {
	...
	$keyName = 'img1/'. basename($_FILES['image']['name']);
...
$s3->upload($bucketName, $keyName, fopen($_FILES['image']['tmp_name'], 'rb'));
  	...
  	$sql = "INSERT INTO users (image, image_text,Nameofbook,Contactno,uid) VALUES ('$image', '$image_text','$name_text','$Contactno','$cook')";
  	// execute query
  	mysqli_query($db, $sql);
...
<?php
 ...
 $bucketName = 'makeiteasycloud';
  ...
  if (isset($_POST['uploads'])) {
	...
	$keyName = 'image3/'. basename($_FILES['image']['name']);
	$pathInS3 = 'https://s3.ap-south-1.amazonaws.com/makeiteasycloud/'. $keyName;
...
$s3->upload($bucketName, $keyName, fopen($_FILES['image']['tmp_name'], 'rb'));
  	...
  	$sql2 = "INSERT INTO ee1 (image, image_text,Nameofbook,Contactno,uid) VALUES ('$image', '$image_text','$name_text','$Contactno','$cook')";
  	// execute query
  ...
  $result1 = mysqli_query($db, "SELECT * FROM ee1");
?>
...
require 'vendor/autoload.php';
  ...
  if (isset($_POST['uploads1'])) {
	...
	$keyName = 'img3/'. basename($_FILES['image']['name']);
	$pathInS3 = 'https://s3.ap-south-1.amazonaws.com/makeiteasycloud/'. $keyName;
...
$s3->upload($bucketName, $keyName, fopen($_FILES['image']['tmp_name'], 'rb'));
  	...
  	$sql3 = "INSERT INTO cp (image, image_text,Nameofbook,Contactno,uid) VALUES ('$image', '$image_text','$name_text','$Contactno','$cook')";
  	// execute query
  ...
  $result2 = mysqli_query($db, "SELECT * FROM cp");
?>
...
require 'vendor/autoload.php';
  ...
  if (isset($_POST['uploads2'])) {
	...
	$keyName = 'etc img/'. basename($_FILES['image']['name']);
	$pathInS3 = 'https://s3.ap-south-1.amazonaws.com/makeiteasycloud/'. $keyName;
...
$s3->upload($bucketName, $keyName, fopen($_FILES['image']['tmp_name'], 'rb'));
  	...
  	$sql3 = "INSERT INTO etc (image, image_text,Nameofbook,Contactno,uid) VALUES ('$image', '$image_text','$name_text','$Contactno','$cook')";
  	// execute query
  	mysqli_query($db, $sql3);
  ...
  $result3 = mysqli_query($db, "SELECT * FROM etc");
...
require 'vendor/autoload.php';
  ...
  if (isset($_POST['uploads3'])) {
	...
	$keyName = 'mech img/'. basename($_FILES['image']['name']);
	$pathInS3 = 'https://s3.ap-south-1.amazonaws.com/makeiteasycloud/'. $keyName;
...
$s3->upload($bucketName, $keyName, fopen($_FILES['image']['tmp_name'], 'rb'));
  	...
  	$sql4 = "INSERT INTO be (image, image_text,Nameofbook,Contactno,uid) VALUES ('$image', '$image_text','$name_text','$Contactno','$cook')";
  	// execute query
  ...
  $result4 = mysqli_query($db, "SELECT * FROM be");
?>
...
require 'vendor/autoload.php';
  ...
  if (isset($_POST['uploads4'])) {
	...
	$keyName = 'pe img/'. basename($_FILES['image']['name']);
	$pathInS3 = 'https://s3.ap-south-1.amazonaws.com/makeiteasycloud/'. $keyName;
...
$s3->upload($bucketName, $keyName, fopen($_FILES['image']['tmp_name'], 'rb'));
  	...
  	$sql5 = "INSERT INTO pe (image, image_text,Nameofbook,Contactno,uid) VALUES ('$image', '$image_text','$name_text','$Contactno','$cook')";
  	// execute query
  ...
  $result5 = mysqli_query($db, "SELECT * FROM pe");
?>
...
require 'vendor/autoload.php';
  ...
  if (isset($_POST['uploads5'])) {
	...
	$keyName = 'civil img/'. basename($_FILES['image']['name']);
	$pathInS3 = 'https://s3.ap-south-1.amazonaws.com/makeiteasycloud/'. $keyName;
...
$s3->upload($bucketName, $keyName, fopen($_FILES['image']['tmp_name'], 'rb'));
  	...
  	$sql6 = "INSERT INTO civil (image, image_text,Nameofbook,Contactno,uid) VALUES ('$image', '$image_text','$name_text','$Contactno','$cook')";
  	// execute query
  ...
  $result6 = mysqli_query($db, "SELECT * FROM civil");
?>
...
require 'vendor/autoload.php';
  ...
  if (isset($_POST['uploads6'])) {
	...
	$keyName = 'ce img/'. basename($_FILES['image']['name']);
	$pathInS3 = 'https://s3.ap-south-1.amazonaws.com/makeiteasycloud/'. $keyName;
...
$s3->upload($bucketName, $keyName, fopen($_FILES['image']['tmp_name'], 'rb'));
  	...
  	$sql7 = "INSERT INTO chemical (image, image_text,Nameofbook,Contactno,uid) VALUES ('$image', '$image_text','$name_text','$Contactno','$cook')";
  	// execute query
  ...
  $result7 = mysqli_query($db, "SELECT * FROM chemical");
?>
...
require 'vendor/autoload.php';
  ...
  if (isset($_POST['uploads7'])) {
	...
	$keyName = 'met img/'. basename($_FILES['image']['name']);
	$pathInS3 = 'https://s3.ap-south-1.amazonaws.com/makeiteasycloud/'. $keyName;
...
$s3->upload($bucketName, $keyName, fopen($_FILES['image']['tmp_name'], 'rb'));
  	...
  	$sql8 = "INSERT INTO met (image, image_text,Nameofbook,Contactno,uid) VALUES ('$image', '$image_text','$name_text','$Contactno','$cook')";
  	// execute query
  ...
  $result8 = mysqli_query($db, "SELECT * FROM met");
?>
...
require 'vendor/autoload.php';
  ...
  if (isset($_POST['uploads8'])) {
	...
	$keyName = 'cs2 img/'. basename($_FILES['image']['name']);
	$pathInS3 = 'https://s3.ap-south-1.amazonaws.com/makeiteasycloud/'. $keyName;
...
$s3->upload($bucketName, $keyName, fopen($_FILES['image']['tmp_name'], 'rb'));
  	...
  	$sql9 = "INSERT INTO cs2 (image, image_text,Nameofbook,Contactno,uid) VALUES ('$image', '$image_text','$name_text','$Contactno','$cook')";
  	// execute query
  ...
  $result9 = mysqli_query($db, "SELECT * FROM cs2");
?>
...
require 'vendor/autoload.php';
  ...
  if (isset($_POST['uploads9'])) {
	...
	$keyName = 'ee2 img/'. basename($_FILES['image']['name']);
	$pathInS3 = 'https://s3.ap-south-1.amazonaws.com/makeiteasycloud/'. $keyName;
...
$s3->upload($bucketName, $keyName, fopen($_FILES['image']['tmp_name'], 'rb'));
  	...
  	$sql10 = "INSERT INTO ee2 (image, image_text,Nameofbook,Contactno,uid) VALUES ('$image', '$image_text','$name_text','$Contactno','$cook')";
  	// execute query
  ...
  $result10 = mysqli_query($db, "SELECT * FROM ee2");
?>
...
require 'vendor/autoload.php';
 ...
 $bucketName = 'makeiteasycloud';
  ...
  if (isset($_POST['uploads10'])) {
	...
	$keyName = 'eee2 img/'. basename($_FILES['image']['name']);
	$pathInS3 = 'https://s3.ap-south-1.amazonaws.com/makeiteasycloud/'. $keyName;
...
$s3->upload($bucketName, $keyName, fopen($_FILES['image']['tmp_name'], 'rb'));
  	...
  	$sql10 = "INSERT INTO eee2 (image, image_text,Nameofbook,Contactno,uid) VALUES ('$image', '$image_text','$name_text','$Contactno','$cook')";
  	// execute query
  	mysqli_query($db, $sql10);
  ...
  $result11 = mysqli_query($db, "SELECT * FROM eee2");
?>
...
require 'vendor/autoload.php';
  ...
  if (isset($_POST['uploads11'])) {
	...
	$keyName = 'etc2 img/'. basename($_FILES['image']['name']);
	$pathInS3 = 'https://s3.ap-south-1.amazonaws.com/makeiteasycloud/'. $keyName;
...
$s3->upload($bucketName, $keyName, fopen($_FILES['image']['tmp_name'], 'rb'));
  	...
  	$sql10 = "INSERT INTO etc2 (image, image_text,Nameofbook,Contactno,uid) VALUES ('$image', '$image_text','$name_text','$Contactno','$cook')";
  	// execute query
  	mysqli_query($db, $sql10);
  ...
  $result12 = mysqli_query($db, "SELECT * FROM etc2");
?>
...
require 'vendor/autoload.php';
  ...
  if (isset($_POST['uploads12'])) {
	...
	$keyName = 'me2 img/'. basename($_FILES['image']['name']);
	$pathInS3 = 'https://s3.ap-south-1.amazonaws.com/makeiteasycloud/'. $keyName;
...
$s3->upload($bucketName, $keyName, fopen($_FILES['image']['tmp_name'], 'rb'));
  	...
  	$sql10 = "INSERT INTO me2 (image, image_text,Nameofbook,Contactno,uid) VALUES ('$image', '$image_text','$name_text','$Contactno','$cook')";
  	// execute query
  	mysqli_query($db, $sql10);
  ...
  $result13 = mysqli_query($db, "SELECT * FROM me2");
?>
...
require 'vendor/autoload.php';
  ...
  if (isset($_POST['uploads13'])) {
	...
	$keyName = 'pe2 img/'. basename($_FILES['image']['name']);
	$pathInS3 = 'https://s3.ap-south-1.amazonaws.com/makeiteasycloud/'. $keyName;
...
$s3->upload($bucketName, $keyName, fopen($_FILES['image']['tmp_name'], 'rb'));
  	...
  	$sql10 = "INSERT INTO pe2 (image, image_text,Nameofbook,Contactno,uid) VALUES ('$image', '$image_text','$name_text','$Contactno','$cook')";
  	// execute query
  	mysqli_query($db, $sql10);
  ...
  $result14 = mysqli_query($db, "SELECT * FROM pe2");
?>
...
require 'vendor/autoload.php';
 ...
 $bucketName = 'makeiteasycloud';
  ...
  if (isset($_POST['uploads14'])) {
	...
	$keyName = 'civil2 img/'. basename($_FILES['image']['name']);
	$pathInS3 = 'https://s3.ap-south-1.amazonaws.com/makeiteasycloud/'. $keyName;
...
$s3->upload($bucketName, $keyName, fopen($_FILES['image']['tmp_name'], 'rb'));
  	...
  	$sql10 = "INSERT INTO civil2 (image, image_text,Nameofbook,Contactno,uid) VALUES ('$image', '$image_text','$name_text','$Contactno','$cook')";
  	// execute query
  	mysqli_query($db, $sql10);
  ...
  $result15 = mysqli_query($db, "SELECT * FROM civil2");
?>
...
require 'vendor/autoload.php';
  ...
  if (isset($_POST['uploads15'])) {
	...
	$keyName = 'ce2 img/'. basename($_FILES['image']['name']);
	$pathInS3 = 'https://s3.ap-south-1.amazonaws.com/makeiteasycloud/'. $keyName;
...
$s3->upload($bucketName, $keyName, fopen($_FILES['image']['tmp_name'], 'rb'));
  	...
  	$sql10 = "INSERT INTO ce2 (image, image_text,Nameofbook,Contactno,uid) VALUES ('$image', '$image_text','$name_text','$Contactno','$cook')";
  	// execute query
  	mysqli_query($db, $sql10);
  ...
  $result16 = mysqli_query($db, "SELECT * FROM ce2");
?>
...
require 'vendor/autoload.php';
  ...
  if (isset($_POST['uploads16'])) {
	...
	$keyName = 'met2 img/'. basename($_FILES['image']['name']);
	$pathInS3 = 'https://s3.ap-south-1.amazonaws.com/makeiteasycloud/'. $keyName;
...
$s3->upload($bucketName, $keyName, fopen($_FILES['image']['tmp_name'], 'rb'));
  	...
  	$sql10 = "INSERT INTO met2 (image, image_text,Nameofbook,Contactno,uid) VALUES ('$image', '$image_text','$name_text','$Contactno','$cook')";
  	// execute query
  	mysqli_query($db, $sql10);
  ...
  $result17 = mysqli_query($db, "SELECT * FROM met2");
?>
<html>
<head>
...
<nav class="navbar navbar-expand-lg navbar-light bg-dark navbar-fixed-top" id="just">
<span  class="span" onclick="openNav()">&#9776; open</span>
  ...
  <button class="navbar-toggler" id="navba" type="button" data-toggle="collapse" data-target="#navbarNavDropdown" aria-controls="navbarNavDropdown" aria-expanded="false" aria-label="Toggle navigation">
...
<div id="header" class="head">
  ...
  <div class="container-fluid">
   <div class="col-md-12 col-sm-12">  
	 ...
	 <form action="search 2.php" method="get" class="form">
...
<div id="mySidenav" class="sidenav">
  ...
  <a href="https://makeiteasy-vssut.herokuapp.com/new%201.php">First Year</a>
   <button class="dropdown-btn">Second Year 
...
<hr>
<form method="post" action="new 2.php" enctype="multipart/form-data" id="frm">
 ...
 while ($row = mysqli_fetch_array($result)) {
	 ...
	 $me=$row['id'];
      ...
      echo "<div class='card' id='crd'>";
      	...
      	echo "<a href=''><img src='https://s3.ap-south-1.amazonaws.com/makeiteasycloud/img1/".$row['image']."' class='card-img-top'></a>";
		...
		if($cook==$row['uid']){
	     ...
	     echo "<a href='del 2.php?del=$me'><button type='button' class='btn btn-danger'>delete</button></a><br />";
...
<hr>
<form method="post" action="new 2.php" enctype="multipart/form-data">
<input type="hidden" name="size" value="1000000">
<div>
<input type="file" class="btn btn-danger" name="image">
</div>
 ...
 while ($row = mysqli_fetch_array($result1)) {
	 ...
	 $me=$row['id'];
      ...
      echo "<div class='card' id='crd'>";
      	...
      	echo "<a href=''><img src='https://s3.ap-south-1.amazonaws.com/makeiteasycloud/image3/".$row['image']."' class='card-img-top'></a>";
		echo "<div class='card-body'>";
      	echo " <h5 class='card-title'>Book Name<br>".$row['Nameofbook']."</h5>";
		echo " <h5 class='card-title'>Price<br>".$row['image_text']."</h5>";
		echo " <h5 class='card-title'>Contactno<br>".$row['Contactno']."</h5>";
...
<div class="flex-container">
 ...
 while ($row = mysqli_fetch_array($result2)) {
     ...
     echo "<div>";
      echo "<div class='card' id='crd'>";
      	echo "<a href=''><img src='https://s3.ap-south-1.amazonaws.com/makeiteasycloud/img3/".$row['image']."' class='card-img-top'></a>";
		echo "<div class='card-body'>";
      	echo " <h5 class='card-title'>Book Name<br>".$row['Nameofbook']."</h5>";
		echo " <h5 class='card-title'>Price<br>".$row['image_text']."</h5>";
		echo " <h5 class='card-title'>Contactno<br>".$row['Contactno']."</h5>";
...
<div class="flex-container">
 ...
 $cook=$_COOKIE['id'];
      ...
      echo "<div>";
      echo "<div class='card' id='crd'>";
      	echo "<a href=''><img src='https://s3.ap-south-1.amazonaws.com/makeiteasycloud/etc img/".$row['image']."' class='card-img-top'></a>";
		echo "<div class='card-body'>";
      	echo " <h5 class='card-title'>Book Name<br>".$row['Nameofbook']."</h5>";
		echo " <h5 class='card-title'>Price<br>".$row['image_text']."</h5>";
		echo " <h5 class='card-title'>Contactno<br>".$row['Contactno']."</h5>";
...
<div class="flex-container">
 ...
 $cook=$_COOKIE['id'];
        while ($row = mysqli_fetch_array($result4)) {
          ...
          echo "<div>";
      echo "<div class='card' id='crd'>";
      	echo "<a href=''><img src='https://s3.ap-south-1.amazonaws.com/makeiteasycloud/mech img/".$row['image']."' class='card-img-top'></a>";
		echo "<div class='card-body'>";
      	echo " <h5 class='card-title'>Book Name<br>".$row['Nameofbook']."</h5>";
		echo " <h5 class='card-title'>Price<br>".$row['image_text']."</h5>";
		echo " <h5 class='card-title'>Contactno<br>".$row['Contactno']."</h5>";
 ...
 $cook=$_COOKIE['id'];
        while ($row = mysqli_fetch_array($result5)) {
          $me=$row['id'];
		   echo "<div>";
      echo "<div class='card' id='crd'>";
      	echo "<a href=''><img src='https://s3.ap-south-1.amazonaws.com/makeiteasycloud/pe img/".$row['image']."' class='card-img-top'></a>";
		echo "<div class='card-body'>";
      	echo " <h5 class='card-title'>Book Name<br>".$row['Nameofbook']."</h5>";
		echo " <h5 class='card-title'>Price<br>".$row['image_text']."</h5>";
		echo " <h5 class='card-title'>Contactno<br>".$row['Contactno']."</h5>";
 ...
 while ($row = mysqli_fetch_array($result6)) {
	 ...
	 $me=$row['id'];
      ...
      echo "<div class='card' id='crd'>";
      	...
      	echo "<a href=''><img src='https://s3.ap-south-1.amazonaws.com/makeiteasycloud/civil img/".$row['image']."' class='card-img-top'></a>";
		echo "<div class='card-body'>";
      	echo " <h5 class='card-title'>Book Name<br>".$row['Nameofbook']."</h5>";
		echo " <h5 class='card-title'>Price<br>".$row['image_text']."</h5>";
		echo " <h5 class='card-title'>Contactno<br>".$row['Contactno']."</h5>";
 ...
 while ($row = mysqli_fetch_array($result7)) {
	 ...
	 $me=$row['id'];
      ...
      echo "<div class='card' id='crd'>";
      	...
      	echo "<a href=''><img src='https://s3.ap-south-1.amazonaws.com/makeiteasycloud/ce img/".$row['image']."' class='card-img-top'></a>";
		echo "<div class='card-body'>";
      	echo " <h5 class='card-title'>Book Name<br>".$row['Nameofbook']."</h5>";
		echo " <h5 class='card-title'>Price<br>".$row['image_text']."</h5>";
		echo " <h5 class='card-title'>Contactno<br>".$row['Contactno']."</h5>";
 ...
 while ($row = mysqli_fetch_array($result8)) {
	 ...
	 $me=$row['id'];
      ...
      echo "<div class='card' id='crd'>";
      	...
      	echo "<a href=''><img src='https://s3.ap-south-1.amazonaws.com/makeiteasycloud/met img/".$row['image']."' class='card-img-top'></a>";
		echo "<div class='card-body'>";
      	echo " <h5 class='card-title'>Book Name<br>".$row['Nameofbook']."</h5>";
		echo " <h5 class='card-title'>Price<br>".$row['image_text']."</h5>";
		echo " <h5 class='card-title'>Contactno<br>".$row['Contactno']."</h5>";
 ...
 while ($row = mysqli_fetch_array($result9)) {
	 ...
	 $me=$row['id'];
      ...
      echo "<div class='card' id='crd'>";
      	...
      	echo "<a href=''><img src='https://s3.ap-south-1.amazonaws.com/makeiteasycloud/cs2 img/".$row['image']."' class='card-img-top'></a>";
		echo "<div class='card-body'>";
      	echo " <h5 class='card-title'>Book Name<br>".$row['Nameofbook']."</h5>";
		echo " <h5 class='card-title'>Price<br>".$row['image_text']."</h5>";
		echo " <h5 class='card-title'>Contactno<br>".$row['Contactno']."</h5>";
 ...
 while ($row = mysqli_fetch_array($result10)) {
	 ...
	 $me=$row['id'];
      ...
      echo "<div class='card' id='crd'>";
      	...
      	echo "<a href=''><img src='https://s3.ap-south-1.amazonaws.com/makeiteasycloud/ee2 img/".$row['image']."' class='card-img-top'></a>";
		echo "<div class='card-body'>";
      	echo " <h5 class='card-title'>Book Name<br>".$row['Nameofbook']."</h5>";
		echo " <h5 class='card-title'>Price<br>".$row['image_text']."</h5>";
		echo " <h5 class='card-title'>Contactno<br>".$row['Contactno']."</h5>";
 ...
 while ($row = mysqli_fetch_array($result11)) {
	 ...
	 $me=$row['id'];
      ...
      echo "<div class='card' id='crd'>";
      	...
      	echo "<a href=''><img src='https://s3.ap-south-1.amazonaws.com/makeiteasycloud/eee2 img/".$row['image']."' class='card-img-top'></a>";
		echo "<div class='card-body'>";
      	echo " <h5 class='card-title'>Book Name<br>".$row['Nameofbook']."</h5>";
		echo " <h5 class='card-title'>Price<br>".$row['image_text']."</h5>";
		echo " <h5 class='card-title'>Contactno<br>".$row['Contactno']."</h5>";
 ...
 while ($row = mysqli_fetch_array($result12)) {
	 ...
	 $me=$row['id'];
      ...
      echo "<div class='card' id='crd'>";
      	...
      	echo "<a href=''><img src='https://s3.ap-south-1.amazonaws.com/makeiteasycloud/etc2 img/".$row['image']."' class='card-img-top'></a>";
		echo "<div class='card-body'>";
      	echo " <h5 class='card-title'>Book Name<br>".$row['Nameofbook']."</h5>";
		echo " <h5 class='card-title'>Price<br>".$row['image_text']."</h5>";
		echo " <h5 class='card-title'>Contactno<br>".$row['Contactno']."</h5>";
 ...
 while ($row = mysqli_fetch_array($result13)) {
	 ...
	 $me=$row['id'];
      ...
      echo "<div class='card' id='crd'>";
      	...
      	echo "<a href=''><img src='https://s3.ap-south-1.amazonaws.com/makeiteasycloud/me2 img/".$row['image']."' class='card-img-top'></a>";
		echo "<div class='card-body'>";
      	echo " <h5 class='card-title'>Book Name<br>".$row['Nameofbook']."</h5>";
		echo " <h5 class='card-title'>Price<br>".$row['image_text']."</h5>";
		echo " <h5 class='card-title'>Contactno<br>".$row['Contactno']."</h5>";
 ...
 while ($row = mysqli_fetch_array($result14)) {
	 ...
	 $me=$row['id'];
      ...
      echo "<div class='card' id='crd'>";
      	...
      	echo "<a href=''><img src='https://s3.ap-south-1.amazonaws.com/makeiteasycloud/pe2 img/".$row['image']."' class='card-img-top'></a>";
		echo "<div class='card-body'>";
      	echo " <h5 class='card-title'>Book Name<br>".$row['Nameofbook']."</h5>";
		echo " <h5 class='card-title'>Price<br>".$row['image_text']."</h5>";
		echo " <h5 class='card-title'>Contactno<br>".$row['Contactno']."</h5>";
 ...
 while ($row = mysqli_fetch_array($result15)) {
	 ...
	 $me=$row['id'];
      ...
      echo "<div class='card' id='crd'>";
      	...
      	echo "<a href=''><img src='https://s3.ap-south-1.amazonaws.com/makeiteasycloud/civil2 img/".$row['image']."' class='card-img-top'></a>";
		echo "<div class='card-body'>";
      	echo " <h5 class='card-title'>Book Name<br>".$row['Nameofbook']."</h5>";
		echo " <h5 class='card-title'>Price<br>".$row['image_text']."</h5>";
		echo " <h5 class='card-title'>Contactno<br>".$row['Contactno']."</h5>";
 ...
 while ($row = mysqli_fetch_array($result16)) {
	 ...
	 $me=$row['id'];
      ...
      echo "<div class='card' id='crd'>";
      	...
      	echo "<a href=''><img src='https://s3.ap-south-1.amazonaws.com/makeiteasycloud/ce2 img/".$row['image']."' class='card-img-top'></a>";
		echo "<div class='card-body'>";
      	echo " <h5 class='card-title'>Book Name<br>".$row['Nameofbook']."</h5>";
		echo " <h5 class='card-title'>Price<br>".$row['image_text']."</h5>";
		echo " <h5 class='card-title'>Contactno<br>".$row['Contactno']."</h5>";
 ...
 while ($row = mysqli_fetch_array($result17)) {
	 ...
	 $me=$row['id'];
      ...
      echo "<div class='card' id='crd'>";
      	...
      	echo "<a href=''><img src='https://s3.ap-south-1.amazonaws.com/makeiteasycloud/met2 img/".$row['image']."' class='card-img-top'></a>";
		echo "<div class='card-body'>";
      	echo " <h5 class='card-title'>Book Name<br>".$row['Nameofbook']."</h5>";
		echo " <h5 class='card-title'>Price<br>".$row['image_text']."</h5>";
		echo " <h5 class='card-title'>Contactno<br>".$row['Contactno']."</h5>";
